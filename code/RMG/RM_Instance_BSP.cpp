...
CRMBSPInstance::CRMBSPInstance(CGPGroup *instGroup, CRMInstanceFile& instFile)  : CRMInstance ( instGroup, instFile )
{
	...
	if (0 == _strcmpi(automapSymName, "none"))	   	mAutomapSymbol = AUTOMAP_NONE ;
	else if (0 == _strcmpi(automapSymName, "building"))  	mAutomapSymbol = AUTOMAP_BLD  ;
	else if (0 == _strcmpi(automapSymName, "objective")) 	mAutomapSymbol = AUTOMAP_OBJ  ;
	else if (0 == _strcmpi(automapSymName, "start"))	   	mAutomapSymbol = AUTOMAP_START;
	else if (0 == _strcmpi(automapSymName, "end"))	   	mAutomapSymbol = AUTOMAP_END  ;
	else if (0 == _strcmpi(automapSymName, "enemy"))	   	mAutomapSymbol = AUTOMAP_ENEMY;
	else if (0 == _strcmpi(automapSymName, "friend"))	   	mAutomapSymbol = AUTOMAP_FRIEND;
	else if (0 == _strcmpi(automapSymName, "wall"))	   	mAutomapSymbol = AUTOMAP_WALL;
