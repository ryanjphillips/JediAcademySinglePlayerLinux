...
void R_WorldEffectCommand(const char *command)
{
	...
	//--------------------------------------------------------
	else if (_strcmpi(token, "freeze") == 0)
	{
		mFrozen = !mFrozen;
	}
	...
	// Constant Wind
	//---------------
	else if (_strcmpi(token, "constantwind") == 0)
	{
		if (mWindZones.full())
		{
			return;
	...
	// Gusting Wind
	//--------------
	else if (_strcmpi(token, "gustingwind") == 0)
	{
		if (mWindZones.full())
		{
			return;
	...
	// Local Wind Zone
	//-----------------
	else if (_strcmpi(token, "windzone") == 0)
	{
		if (mWindZones.full())
		{
			return;
	...
	// Create A Rain Storm
	//---------------------
	else if (_strcmpi(token, "lightrain") == 0)
	{
	...
	// Create A Rain Storm
	//---------------------
	else if (_strcmpi(token, "acidrain") == 0)
	{
		if (mParticleClouds.full())
		{
			return;
	...
	// Create A Rain Storm
	//---------------------
	else if (_strcmpi(token, "heavyrain") == 0)
	{
		if (mParticleClouds.full())
		{
			return;
	...
	// Create A Some stuff
	//---------------------
	else if (_strcmpi(token, "spacedust") == 0)
	{
		int count;
		if (mParticleClouds.full())
		{
	...
	//-----------------------------------
	else if (_strcmpi(token, "heavyrainfog") == 0)
	{
		if (mParticleClouds.full())
		{
			return;
	...
	// Create Blowing Clouds Of Fog
	//------------------------------
	else if (_strcmpi(token, "light_fog") == 0)
	{
		if (mParticleClouds.full())
		{
			return;
	...
	else if (_strcmpi(token, "outsideshake") == 0)
	{
		mOutside.mOutsideShake = !mOutside.mOutsideShake;
	}
	else if (_strcmpi(token, "outsidepain") == 0)
	{
